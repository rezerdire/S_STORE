...
class CustomersPolicy
{
    ...
    {
        return $user->can('delete_any_customers');
    }
    ...
    {
        return $user->can('force_delete_any_customers');
    }
    ...
    {
        return $user->can('restore_any_customers');
    }
    ...
    {
        return $user->can('replicate_customers');
    }
    ...
    {
        return $user->can('reorder_customers');
    }
}
